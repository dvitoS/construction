...
const TotalCostSheetPage: React.FC = () => {
  ...
  const status: ConstructionStatus = ConstructionStatus.Finished;
    ...
    <tbody className="fw-bold text-gray-600">
      ...
      {/*   <!--end::Created date-->
       ...
       {/*  <!--end::Customer-->
        ...
        <td className="text-end">
          <button 
          type="button" className="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px"
